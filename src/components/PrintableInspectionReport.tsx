...
export const PrintableInspectionReport = forwardRef<HTMLDivElement, PrintableInspectionReportProps>(({ report, mode = 'full' }, ref) => {
    ...
    const flatSectorServices = [
        { key: 'engineFlash', label: 'فلاش محرك', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'engineOil', label: 'زيت محرك', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'viscosity', label: 'اللزوجة' }, { key: 'qty', label: 'عدد اللترات' }, { key: 'unitPrice', label: 'س/لتر' }] },
        { key: 'oilFilter', label: 'فلتر زيت محرك', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'filterNum', label: 'الرقم' }] },
        { key: 'coolant', label: 'ماء / سائل تبريد', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'العدد' }, { key: 'unitPrice', label: 'سعر العبوة' }] },
        { key: 'engineCeramic', label: 'سيراميك محرك', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'linerCleaner', label: 'منظف بطانة (جكجكة)', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'oilLeakPreventer', label: 'مانع تسريب زيت', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'smokePreventer', label: 'مانع دخان / نقص زيت', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'gearboxFlash', label: 'فلاش كير', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'gearboxOil', label: 'زيت كير', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'اللترات' }] },
        { key: 'gearboxFilter', label: 'فلتر كير', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'filterNum', label: 'الرقم' }, { key: 'unitPrice', label: 'السعر' }] },
        { key: 'gearboxCeramic', label: 'سيراميك كير', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'gearboxAntiSlip', label: 'مانع انزلاق الكير', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'airFilter', label: 'فلتر هواء', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'filterNum', label: 'الرقم' }] },
        { key: 'acFilter', label: 'فلتر تبريد', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'filterNum', label: 'الرقم' }] },
        { key: 'acCleaner', label: 'منظف دورة التبريد', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'brakeFluid', label: 'زيت بريك', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'عدد القطع' }] },
        { key: 'injectorCleaner', label: 'منظف بخاخات', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'fuelSystemCleaner', label: 'منظف نظام الوقود', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'octaneBooster', label: 'أوكتان بنزين', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'battery', label: 'البطارية', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'batteryFilter', label: 'فلتر البطارية', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
        { key: 'wipers', label: 'مساحات زجاج', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'size', label: 'الحجم' }] },
        { key: 'windshieldFluid', label: 'سائل غسيل جام', fields: [{ key: 'brand', label: 'النوع / الماركة' }, { key: 'qty', label: 'الكمية' }] },
    ];
