            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div className="xl:col-span-4 space-y-4">
                    ...
                    <div className="glass-card rounded-2xl overflow-hidden flex flex-col max-h-[700px] border border-rose-900/20 shadow-xl shadow-black">
                                    ...
                                    <button 
                                        ...
                                        className={`w-full text-right p-4 rounded-xl border transition-all flex flex-col gap-2 relative overflow-hidden ${
                                            selectedReportId === report.id 
                                                ...
                                                : "bg-[#0a0a0a] border-slate-800/80 hover:bg-[#111] hover:border-slate-700"
                                        }`}
                                    >
                                        ...
                                        <div className="flex justify-between items-start w-full pr-2">
                                            <span className="text-xs font-bold text-white bg-black px-2 py-1 rounded-md border border-slate-800">#{report.report_number}</span>
                                            <span className={`text-[10px] sm:text-xs px-2 py-1 rounded-full border truncate max-w-[100px] ${
                                                ...
                                                'bg-[#111] text-slate-400 border-slate-700'
                                            }`}>
                                                {report.status}
                                            </span>
                                        </div>
                                        <div className="flex items-center gap-2 mt-1 pr-2">
                                            ...
                                            <span className="font-bold text-slate-200 text-sm truncate">{report.vehicles.make} - {report.vehicles.plate_number}</span>
                                        </div>
                        ...
                        <div className="p-3 bg-[#0a0a0a] border-t border-rose-900/30 flex items-center justify-between shadow-inner shrink-0">
                            <button 
                ...
                <div className="xl:col-span-8 overflow-x-auto bg-[#050505] p-4 md:p-8 rounded-3xl border border-rose-900/20 shadow-inner">
                    {!selectedReport ? (
                        ...
                        <div className="flex flex-col gap-8">
                                            ...
                                            {usedParts.length === 0 ? (
                                                ...
                                                <div key={p.id} className="flex justify-between items-center text-sm border-b border-slate-800/50 pb-1">
                                                    <div className="flex flex-col">
                                                        <span className="text-slate-300">{p.inventory.name}</span>
                            ...
                            <div className="shadow-2xl mx-auto min-w-[794px] w-[210mm] bg-[#f8fafc] text-slate-900 rounded-lg overflow-hidden flex justify-center py-4 print:py-0 print:shadow-none">
